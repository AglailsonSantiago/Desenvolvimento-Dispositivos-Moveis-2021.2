...
public class ConfiguracoesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        identificadorUser = UserFirebase.getIdenficadorUser();
        ...
        imageAtualizarNome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                boolean retorno = UserFirebase.atualizarNomeUser(nome);
            ...
            try {
                ...
                if(imagem != null){
                    ...
                    final StorageReference imagemRef = storageReference
                            .child("imagens")
                            .child("perfil")
                            .child(identificadorUser + "perfil.jpeg");
    ...
    public void atualizaFotoUser(Uri url){
        ...
        boolean retorno = UserFirebase.atualizarFotoUser(url);
